...
public class LightTest extends BasicGame {
	...
	/**
	 * True if we're going to render coloured lighting .... oooooh disco
	 * inferno!
	 */
	...
	/**
	 * The main light that we'll move around with the mouse, held seperately so
	 * we can update it
	 */
	 ...
	 * @param delta
	 *            The amount of time that passed since last update (in seconds)
	 */
	 ...
	 * @param x
	 *            The x coordinate the mouse was pressed at
	 * @param y
	 *            The y coordinate the mouse was pressed at
	 */
	 ...
	 *            The container the game is running in
	 * @param g
	 *            The graphics context to which we can render
	 */
		...
		for (int y = 0; y < HEIGHT; y++) {
			for (int x = 0; x < WIDTH; x++) {
				...
				if (lightingOn) {
					...
					image.setColor(Image.TOP_LEFT, lightValue[x][y][0],
							lightValue[x][y][1], lightValue[x][y][2], 1);
					image.setColor(Image.TOP_RIGHT, lightValue[x + 1][y][0],
							lightValue[x + 1][y][1], lightValue[x + 1][y][2], 1);
					image.setColor(Image.BOTTOM_RIGHT,
							lightValue[x + 1][y + 1][0],
							lightValue[x + 1][y + 1][1],
							lightValue[x + 1][y + 1][2], 1);
					image.setColor(Image.BOTTOM_LEFT, lightValue[x][y + 1][0],
	 ...
	 *
	 * @param argv
	 *            The arguments provided at the command line
	 */
