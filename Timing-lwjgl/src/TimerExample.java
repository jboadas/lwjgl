...
public class TimerExample {
    ...
    public void start() {
        try {
            ...
            Display.create();
            //IntBuffer textureBuffer = ByteBuffer.allocateDirect(64).asIntBuffer();
            IntBuffer textureBuffer = BufferUtils.createIntBuffer(16);
            GL11.glGetInteger(GL11.GL_MAX_TEXTURE_SIZE, textureBuffer);
            ...
            System.out.println("Max texture size using Buffer: " + textureBuffer.get());
