...
public class JOGL2NewtDemo implements GLEventListener, KeyListener, MouseListener {  // Renderer
   ...
   public static void main(String[] args) {
       ...
       JOGL2NewtDemo demo = new JOGL2NewtDemo();
       window.addGLEventListener(demo);
       window.addKeyListener(demo);
       window.addMouseListener(demo);
...
public void mouseWheelMoved(MouseEvent e) {
	...
	System.out.println("Mouse Moved : [0] " + e.getRotation()[0] + " [1] " +e.getRotation()[1] + " [1] " + e.getRotation()[2]);
